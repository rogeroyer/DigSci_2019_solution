...
train_index = similarities.SparseMatrixSimilarity.load('{}train_index.index'.format(model_path))
...
if __name__=='__main__':
    ...
    df = pd.DataFrame(submit)
    df.to_csv('{}train_pairs_10number_tfidf.csv'.format(model_path), header=None, index=False)
